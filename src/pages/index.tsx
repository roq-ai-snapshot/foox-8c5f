  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Foox: Empowering Freelancers Worldwide. A Job Marketplace Where Companies Meet Talent and Opportunities are Unleashed."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Foox: Empowering Freelancers Worldwide. A Job Marketplace Where Companies Meet Talent and Opportunities are Unleashed.`}
            </Text>
            <Box
