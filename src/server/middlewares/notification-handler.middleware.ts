...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'New Proposal Submitted.create': {
    roles: ['owner', 'recruiter'],
    key: 'proposal_submitted',
    tenantPath: [],
    userPath: [],
  },
  'Freelancer Shortlisted.update': { roles: ['owner'], key: 'freelancer_shortlisted', tenantPath: [], userPath: [] },
  'Freelancer Approved.update': { roles: ['recruiter'], key: 'freelancer_approved', tenantPath: [], userPath: [] },
};
